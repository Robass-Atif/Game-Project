...
// enemy3 functions
void moveenemy2(char enemy[2][5],int &enemy2X);
void printenemy2(char enemy[2][5],int &enemy2X);
void eraseenemy2(int &enemy2X);
// enemy1 bullets
...
// enemy3 bullets
void generateenemy2bullet(int &enemy2X);
...
void printhealth();
// player functions
void bulletCollisionWithEnemy(int &enemyX, int &enemyY, int &enemy1X, int &enemy1Y,int &enemy2X);
void printBullet(int x, int y);
void eraseBullet(int x, int y);
void printBigBullet(int, int);
void eraseBigBullet(int, int);
void playerCollisionWithEnemy(char ship[][5], int &shipX, int &shipY, int &enemyX, int &enemyY, int &enemy1X, int &enemy1Y,int &enemy2X);
// other functions
void gameInterface(int &shipX, int &shipY, int &enemyX, int &enemyY, int &enemy1X, int &enemy1Y,int &enemy2X); // function where game starts
void header();
...
void writeScore(int);
void loadScore();
void writeRecord(int &shipX, int &shipY, int &enemyX, int &enemyY, int &enemy1X, int &enemy1Y,int &enemy2X);
void loadRecord(int &shipX, int &shipY, int &enemyX, int &enemyY, int &enemy1X, int &enemy1Y,int &enemy2X);
int largestScore();
string gameOption();
void startGame();
void newGame(int &shipX, int &shipY, int &enemyX, int &enemyY, int &enemy1Y,int &enemy2X);
...
void newGame(int &shipX, int &shipY, int &enemyX, int &enemyY, int &enemy1X, int &enemy1Y,int &enemy2X)
{
    smartEnemyX = 54;
    smartEnemyY = 3;
    smartHealth = 10;
    ...
    eraseEnemy2 = true;
    eraseEnemy3 = true;
    gameInterface(shipX, shipY, enemyX, enemyY, enemy1X, enemy1Y,enemy2X);
}
void startGame()
{
    int shipX = 5;
    ...
    while (option != "3")
    {
        ...
        if (option == "1")
        {
            if ((life == 0 || collision == true) || (healthofbigenemy == 0))
            {
                ...
                deletePlayerBullet();
                newGame(shipX, shipY, enemyX, enemyY, enemy1X, enemy1Y,enemy2X);
            }
            else
            {
                loadRecord(shipX, shipY, enemyX, enemyY, enemy1X, enemy1Y,enemy2X);
                if (healthofenemy1 != 0)
                {
                    loadEnemyBullet();
                }
...
float distance(int x, int y, int &shipX, int &shipY)
{
...
void gameInterface(int &shipX, int &shipY, int &enemyX, int &enemyY, int &enemy1X, int &enemy1Y,int &enemy2X)
{
    ...
    while (true)
    {
        ...
        if (enemy3Active == true)
        {
            if (timer3 == 20)
            {
                generateenemy2bullet(enemy2X);
                timer3 = 0;
            }
            if (timer5 == 3)
            {
                moveenemy2(enemy,enemy2X);
                timer5 = 0;
            }
        }
        if (healthofenemy1 == 0)
        ...
        moveBullet();
        bulletCollisionWithEnemy(enemyX, enemyY, enemy1X, enemy1Y,enemy2X);
        playerCollisionWithEnemy(ship, shipX, shipY, enemyX, enemyY, enemy1X, enemy1Y,enemy2X);
        timer++;
        timerEnemyBullet1++;
        timer2++;
        timer3++;
    ...
    writeBigBullet();
    writeEnemyBullet();
    writeRecord(shipX, shipY, enemyX, enemyY, enemy1X, enemy1Y,enemy2X);
    system("cls");
    printGameOver();
    int largest = 0;
